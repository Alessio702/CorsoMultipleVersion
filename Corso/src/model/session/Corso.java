...
public class Corso {
	...
	{
		int i;
		for (i = 0; this.partecipanti.get(i).getChiave() != chiavePartecipante; i++);
	...
	public static ArrayList<Integer> elencoDocentiCorso(int chiaveDocente) {
		ArrayList<Integer> elencoDocentiCorso = CorsoSet.elencoDocentiCorso(chiaveDocente);
