...
<body>
 <form method = "post" action = "/Corso/CtrlGestioneCorso" name = "listaPartecipanti">
  ...
  <table bgcolor ="lightgreen" align = "center" border = "1">
   ...
   <% ArrayList pgsElenco = (ArrayList) request.getAttribute("nonPartecipanti");
   ...
   if (pgsElenco.size() > 0)
   {
    for(int i = 0; i < pgsElenco.size(); i++)
    {
     %>
    <tr>
     <td><input type = "radio" name = "rdoIDPartecipante" value ="<%= ((Discente) pgsElenco.get(i)).getChiave() %>" checked = "checked"></td>
