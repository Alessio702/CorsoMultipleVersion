...
<body>
 ...
 <form method = "post" action = "/WebHbCorso/CtrlGestioneCorso">
  ...
  <br><br>
  <% List pgsPartecipanti = (List) request.getAttribute("elencoPartecipanti");
     ...
     <tbody>
      ...
      <%  for (int i = 0; i < pgsPartecipanti.size(); i++) 
       { %>
        <tr>
         <td>
          <input type = "radio" name = "rdoIDPartecipanteElimina" value="<%=((Discente) pgsPartecipanti.get(i)).getId()%>">
         </td>
